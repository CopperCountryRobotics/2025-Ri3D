...
public class AlgeLevelThree extends SequentialCommandGroup {
  /** Creates a new AlgeLevelThree. */
  public AlgeLevelThree(Arm arm, Elevator elevator, Wrist wrist, Flicker flicker) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(
      new WristToPosition(wrist, 0),
      new ArmToPosition(arm, ArmConstants.armVertical),// about straight up in the air
      new ElevatorToPosition(elevator, ElevatorConstants.topHeightAlge)
